...
<head>
    ...
    <title>Agency Detailed Information</title>
...
<body>
	...
	<!-- main -->
	<%@include file="/WEB-INF/views/include/agencydetailmain.jsp" %>
	...
	<!-- hidden value -->
	<input type="hidden" value="${agency.gpsX}" id="lat">
	<input type="hidden" value="${agency.gpsY}" id="lng">
